...
$busca = mysqli_query($con,"select *from alumnos where ci like'%".$_POST['control']."%'");
...
<tr>
<td>ci:</td> 
<td><input type=text name=ci value='$ci'> <br></td>
</tr>
<tr>
<td>Nombre:</td> 
...
<tr>
<td>No.Control:</td> 
<td><input type=text name=no_control value='$no_control' > <br></td></tr>
<tr>
<td>Carrera:</td> 
...
<tr>
<td>ingreso:</td>
<td><input type=text name=ingreso value='$ingreso' > <br></td></tr>
<tr>
<td>egreso:</td>
<td><input type=text name=egreso value='$egreso' > <br></td></tr>
<tr>
